...
// A Writer allows output streams to be wrapped with useful functionality.
...
type BaseArgs struct {
	...
	Stdout   Writer   // The standard output stream, potentially modified.
}
...
type CloneRequest struct {
	...
	Stdout   Writer // A flow rate limiter to conserve bandwidth.
}
